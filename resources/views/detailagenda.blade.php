        ...
        <div class="flex flex-row bg-white sm:py-32 rounded-lg p-4 justify-between">
            <div class="max-w-screen-lg mx-auto p-5 sm:p-10 md:p-16">
                ...
                <div class="mb-10 rounded overflow-hidden flex flex-col mx-auto">
                    <div 
                        class="text-xl sm:text-4xl font-semibold inline-block transition duration-500 ease-in-out inline-block mb-2">
                        {{$data->agenda_name}}
                    </div>

                    <div class="relative">
                        <a href="#">
                            <img class="w-full p-20"
                                src="{{ Storage::url('pamflet-agenda/pamflet-1.png') }}"
                                alt="">
                        </a>
                    </div>
