                ...
                <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class="mt-10 grid grid-cols-12 gap-x-6 gap-y-8 sm:grid-cols-6">
                        ...
                        <div class="sm:col-span-3">
                            <label for="agenda_date" class="block text-sm/6 font-medium text-gray-900">Tanggal Agenda</label>
                            <div class="mt-2">
                                <input type="date" name="agenda_date" id="agenda_date" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6">
                            </div>
                            @error('agenda_date')
                            <text for="" class="text-red-900">
                                {{ $message }}
